...
[![npm version](https://img.shields.io/npm/v/@arkonjs/cli.svg)](https://www.npmjs.com/package/@arkonjs/cli)
...
```
$ npm install @arkonjs/cli --save-dev
$ ./node_modules/.bin/cosmwasm-cli
```
...
```
$ npm install -g @arkonjs/cli
$ cosmwasm-cli
```

## Getting started

1. Install `@arkonjs/cli` and run `cosmwasm-cli` as shown above
