import { OfflineAminoSigner, StdSignature } from "@arkonjs/amino";
import { SignDoc } from "cosmjs-types/cosmos/tx/v1beta1/tx";

/**
 * This is the same as Algo from @arkonjs/launchpad but those might diverge in the future.
 */
export type Algo = "secp256k1" | "ed25519" | "sr25519";

/**
 * This is the same as AccountData from @arkonjs/launchpad but those might diverge in the future.
 */
