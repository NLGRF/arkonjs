...
import { toHex } from "@arkonjs/encoding";
import { Uint53 } from "@arkonjs/math";
import { Tendermint34Client, toRfc3339WithNanoseconds } from "@arkonjs/tendermint-rpc";
...
/**
 * This is the same as BlockHeader from @arkonjs/launchpad but those might diverge in the future.
 */
...
/**
 * This is the same as Block from @arkonjs/launchpad but those might diverge in the future.
 */
...
export interface IndexedTx {
   ...
   * ```
   *
   * Use `decodeTxRaw` from @arkonjs/proto-signing to decode this.
   */
