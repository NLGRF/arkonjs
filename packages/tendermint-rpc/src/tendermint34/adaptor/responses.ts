...
import { fromBase64, fromHex } from "@arkonjs/encoding";
import { JsonRpcSuccessResponse } from "@arkonjs/json-rpc";
...
type RpcSignature = {
   ...
   * There are cases when this is not set, see https://github.com/NLGRF/arkonjs/issues/704#issuecomment-797122415.
   */
 ...
 * This can lead to strings like "0001-01-01T00:00:00Z" (see https://github.com/NLGRF/arkonjs/issues/704#issuecomment-797122415).
