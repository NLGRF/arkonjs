import { fromHex, toAscii } from "@arkonjs/encoding";
import { Uint32, Uint53 } from "@arkonjs/math";
 ...
 *
 * ```ts
 * import { stringToPath } from "@arkonjs/crypto";
 *
 ...
 *
 * ```ts
 * import { HdPath, Slip10RawIndex } from "@arkonjs/crypto";
 *
